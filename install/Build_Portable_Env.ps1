...
Write-Host "======================================================================"
Write-Host "AUDION DOCS AI v3 - BUILD PORTABLE ENV (PS)"
Write-Host "======================================================================"
...
if (-not (Test-Path $initFoldersScript)) {
    throw "Missing file: $initFoldersScript"
}
Invoke-Checked -Label "Initializing managed folders" -Command { & $initFoldersScript }
