...
robocopy "%ROOT%" "%STAGE_PROJECT%" /E /R:1 /W:1 /NFL /NDL /NJH /NJS /NP /XD "%ROOT%\.git" "%ROOT%\release" "%ROOT%\.venv" "%ROOT%\venv" "%ROOT%\__pycache__" /XF "api_key.txt" "api_key_openai.txt" "api_key_gemini.txt" >nul
set "RC=%errorlevel%"
