...
- Project: **Audion Docs AI** (`audion-docs-ai`)
- Run: `20260824T174041Z_audion-docs-ai_daa6ff5a`
- Project root: `S:\Release\Audion Docs AI`
- Scan root: `S:\Release\Audion Docs AI`
- Output: `S:\Release\Audion Docs AI\licenses`
- Status: **PASS**
- Components: 135
- Bundled: 135
- Optional runtime: 0
...
| anthropic | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.0.0 |
| anyio | `NEW_COMPONENT_APPROVED_PROFILE` | - | 4.14.2 |
| attrs | `NEW_COMPONENT_APPROVED_PROFILE` | - | 26.1.0 |
| azure-ai-contentunderstanding | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.2.0b3 |
| azure-ai-documentintelligence | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.0.2 |
| azure-core | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.41.0 |
| azure-identity | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.25.3 |
...
| cobble | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.1.4 |
| colorama | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.4.6 |
| coloredlogs | `NEW_COMPONENT_APPROVED_PROFILE` | - | 15.0.1 |
| cryptography | `NEW_COMPONENT_APPROVED_PROFILE` | - | 50.0.0 |
| defusedxml | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.7.1 |
| distro | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.9.0 |
| docstring_parser | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.18.0 |
...
| google-auth | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2.56.3 |
| google-genai | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2.19.0 |
...
| isodate | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.7.2 |
...
| magika | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.6.3 |
| mammoth | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.11.0 |
| markdown-it-py | `NEW_COMPONENT_APPROVED_PROFILE` | - | 4.2.0 |
| markdown2 | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2.5.5 |
| markdownify | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.2.3 |
| markitdown | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.1.7 |
...
| msal | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.38.0 |
| msal-extensions | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.3.1 |
| multidict | `NEW_COMPONENT_APPROVED_PROFILE` | - | 6.7.1 |
| nicegui | `NEW_COMPONENT_APPROVED_PROFILE` | - | 3.16.0 |
| numpy | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2.5.2 |
| olefile | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.47 |
| onnxruntime | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.20.1 |
| openai | `NEW_COMPONENT_APPROVED_PROFILE` | - | 3.3.1 |
...
| pandas | `NEW_COMPONENT_APPROVED_PROFILE` | - | 3.0.5 |
| pdfminer.six | `NEW_COMPONENT_APPROVED_PROFILE` | - | 20260107 |
| pdfplumber | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.11.10 |
...
| protobuf | `NEW_COMPONENT_APPROVED_PROFILE` | - | 7.36.0 |
| proxy_tools | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.1.0 |
| pyasn1 | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.6.4 |
| pyasn1_modules | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.4.2 |
...
| pydub | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.25.1 |
| Pygments | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2.21.0 |
| PyJWT | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2.13.0 |
| pymupdf | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.28.2 |
| pypdfium2 | `NEW_COMPONENT_APPROVED_PROFILE` | - | 5.13.0 |
...
| python-dateutil | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2.9.0.post0 |
...
| python-pptx | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.0.2 |
...
| tzdata | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2026.3 |
...
| websockets | `NEW_COMPONENT_APPROVED_PROFILE` | - | 16.1.1 |
| wheel | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.48.0 |
| wsproto | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.3.2 |
| xlrd | `NEW_COMPONENT_APPROVED_PROFILE` | - | 2.0.2 |
| xlsxwriter | `NEW_COMPONENT_APPROVED_PROFILE` | - | 3.2.9 |
| yarl | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.24.5 |
| youtube-transcript-api | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.0.3 |
