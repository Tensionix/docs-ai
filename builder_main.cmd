...
title Audion Docs AI v3 - Portable Builder
...
cls
echo ======================================================================
echo   AUDION DOCS AI v3 - PORTABLE BUILDER
echo ======================================================================
echo Root: %BASE_DIR%
echo.

if /I "%AUDION_BUILDER_MENU%"=="hotkey" goto HOTKEY_MENU
...
>>"%MENU_FILE%" echo [91] PROJECT LAUNCHER RU                   ^| project_ru        ^| open Russian workflow menu
>>"%MENU_FILE%" echo [92] TOOLS LAUNCHER                        ^| tools             ^| open service tools menu
>>"%MENU_FILE%" echo.
...
type "%MENU_FILE%" | "%FZF_EXE%" --prompt="audion@docs-v3-builder > " --pointer=">" --header="Pick step:" --layout=reverse --border="rounded" --info=hidden --margin=1,2 > "%RES_FILE%"
...
if /I "%RAW%"=="project_ru" goto PROJECT_RU
...
echo [91] PROJECT LAUNCHER RU
echo [92] TOOLS LAUNCHER
echo.
...
if /I "%RAW%"=="project" goto PROJECT
if /I "%RAW%"=="91" goto PROJECT_RU
if /I "%RAW%"=="project_ru" goto PROJECT_RU
if /I "%RAW%"=="92" goto TOOLS
if /I "%RAW%"=="tools" goto TOOLS
